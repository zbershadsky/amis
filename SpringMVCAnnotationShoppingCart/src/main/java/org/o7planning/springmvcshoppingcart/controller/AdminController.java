...
public class AdminController {
   ...
   // private CustomerInfoValidator customerInfoValidator;
    ...
    public String registration(Model model) {
    	model.addAttribute("userForm", new AccountInfo());
        return "registration";
    }
    
    // POST: Save user
    @RequestMapping(value = { "/registration" }, method = RequestMethod.POST)
    public String registration(@ModelAttribute("userForm") AccountInfo accountInfo, //
        ...
        try {
            accountDAO.saveUser(accountInfo.getUserName(), accountInfo.getPassword());
        } catch (Exception e) {
    ...
    public String proddel(Model model, @RequestParam(value = "code", defaultValue = "") String code) {
        ProductInfo productInfo = null;
        ...
        model.addAttribute("prodInfo", productInfo);
        return "proddel";
    }
    
   
    // POST: Save product
    @RequestMapping(value = { "/proddel" }, method = RequestMethod.POST)
    // Avoid UnexpectedRollbackException (See more explanations)
    @Transactional(propagation = Propagation.NEVER)
    public String productDelete(Model model, //
            @ModelAttribute("prodInfo") @Validated ProductInfo productInfo, //
            BindingResult result, //
            final RedirectAttributes redirectAttributes) {
        ...
        try {
            productDAO.delete(productInfo.getCode());
        } catch (Exception e) {
            // Need: Propagation.NEVER?
            String message = e.getMessage();
            model.addAttribute("message", message);
