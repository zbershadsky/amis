...
<head>
    ...
    <style>
        ...
        .form-container {
            ...
            background: -o-linear-gradient(top, #00a1d2, #105e34);
...
<div class="center">
    ...
    <form class="form-container" action="/reg" method="POST">
        <div class="form-title"><h2>Sign up</h2></div>
            ...
            <input class="form-field" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                   title="I need '@' and letters '.' and 2-3 characters after" required>
