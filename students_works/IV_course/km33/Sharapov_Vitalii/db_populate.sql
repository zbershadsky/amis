INSERT INTO users(u_name, u_password, u_email, u_is_manager, 
  ...
  VALUES ('randrand', 'althor', 'dragon@reborn.net', 1, 
...
INSERT INTO Messages(m_from_fk, m_to_fk, m_timestamp, m_content)
  VALUES ('randrand', 'garreth', SYSTIMESTAMP, 'your name is a bit strange');
INSERT INTO Messages(m_from_fk, m_to_fk, m_timestamp, m_content)
  VALUES ('garreth', 'randrand', SYSTIMESTAMP, 'i know right');
INSERT INTO Messages(m_from_fk, m_to_fk, m_timestamp, m_content)
  VALUES ('randrand', 'garreth', SYSTIMESTAMP, 'you better start doing it now');
INSERT INTO Messages(m_from_fk, m_to_fk, m_timestamp, m_content)
  VALUES ('Thelomen', 'randrand', SYSTIMESTAMP, 
    'i will destroy you whatever you are');
  
INSERT INTO Ceremonies(c_number, u_name_fk, c_date, manager_fk)
  VALUES (0, 'garreth', '19-DEC-16', 'randrand');
INSERT INTO Ceremonies(c_number, u_name_fk, c_date, manager_fk)
  VALUES (1, 'Thelomen', '17-DEC-16', 'randrand');
...
INSERT INTO Artists(a_contract, a_name, 
  ...
  VALUES (0, 'Dandelion', 'witcher@ukr.new', 'live music', 100);
INSERT INTO Artists(a_contract, a_name, 
  a_email, a_genre, a_price_per_day)
  VALUES (1, 'Thomdril Merrilin', 'bard@gmail.com', 'live music', 300);
INSERT INTO Artists(a_contract, a_name, 
  a_email, a_genre, a_price_per_day)
  VALUES (3, 'Seargent Hurtmann', 'pain@yahoo.com', 'PT', 300);
